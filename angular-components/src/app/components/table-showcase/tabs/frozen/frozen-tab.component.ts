...
export class FrozenTabComponent implements OnDestroy {
    public gridData: any[];
    public gridColumns = this.tableShowcaseService.getPeopleTableColumns().splice(0);
    public frozenColumns = this.tableShowcaseService.getPeopleTableColumns().splice(0, 3);
